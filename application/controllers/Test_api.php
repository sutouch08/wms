...
class Test_api extends CI_Controller
{
  ...
  // }
	...
	public function update_web_stock()
	{
		$ds = array(
			array("productCode" => "WA12", "inventory" => 100),
			array("productCode" => "WA13", "inventory" => 100),
			array("productCode" => "WA14", "inventory" => 100),
			array("productCode" => "WA15", "inventory" => 100)
		);
