<div class="row">
    ...
    <div class="col-lg-3-harf col-md-5 col-sm-6-harf col-xs-12 padding-5">
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-6 padding-5 ">
      ...
      <input type="text" class="form-control input-sm edit" id="empName" name="empName" value="<?php echo $order->user_ref; ?>" disabled />
		...
		<div class="col-lg-2 col-md-2-harf col-sm-5 col-xs-12 padding-5">
			<label>คลัง</label>
		...
		<?php if(empty($approve_view) && ($this->pm->can_add OR $this->pm->can_edit)): ?>
			<div class="col-lg-7-harf col-md-5 col-sm-9 col-xs-12 padding-5">
	...
	<?php else : ?>
			<div class="col-lg-8-harf col-md-9 col-sm-9 col-xs-12 padding-5">
				<label>หมายเหตุ</label>
				<input type="text" class="form-control input-sm edit" name="remark" id="remark" value="<?php echo $order->remark; ?>" disabled />
			</div>
		<?php endif; ?>
