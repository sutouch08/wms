	...
	<div class="row">
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<input type="text" name="code" id="code" class="width-100 e" value="" onkeyup="validCode(this)" placeholder="Allow only  a-z, A-Z, 0-9, - , _" autofocus required />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<input type="text" name="name" id="name" class="width-100 e" value="" required />
			</div>
		...
		<div class="form-group hide">
			...
			<div class="col-xs-12 col-sm-3">
				<input type="text" name="old_style" id="old-code" class="width-100 e" value="" placeholder="รหัสรุ่นเก่า (ไม่บังคับ)" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<input type="number" step="any" name="cost" id="cost" class="width-100 e" value="" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<input type="number" step="any" name="price" id="price" class="width-100 e" value="" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<select name="item_group" id="item-group" class="form-control input-sm e">
					<option value="">โปรดเลือก</option>
					<?php echo select_item_group(getConfig('ITEM_GROUP_CODE')); ?>
				</select>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<select name="main_group_code" id="main-group" class="form-control input-sm e" required>
					<option value="">กรุณาเลือก</option>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<select name="group_code" id="group" class="form-control input-sm e" required>
					<option value="">กรุณาเลือก</option>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<select name="sub_group_code" id="sub-group" class="form-control input-sm e">
					<option value="">กรุณาเลือก</option>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<select name="year" id="year" class="form-control input-sm e">
					<option value="">กรุณาเลือก</option>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<label style="padding-top:5px;">
					<input name="count_stock" class="ace ace-switch ace-switch-7" id="count-stock" type="checkbox" value="1" checked />
					<span class="lbl"></span>
				</label>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<label style="padding-top:5px;">
					<input name="can_sell" class="ace ace-switch ace-switch-7" id="can-sell" type="checkbox" value="1" checked />
					<span class="lbl"></span>
				</label>
			</div>
			<div class="help-block col-xs-12 col-sm-reset inline red"></div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<label style="padding-top:5px;">
					<input name="is_api" class="ace ace-switch ace-switch-7" id="is-api" type="checkbox" value="1" />
					<span class="lbl"></span>
				</label>
			</div>
			<div class="help-block col-xs-12 col-sm-reset inline red"></div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3">
				<label style="padding-top:5px;">
					<input name="active" class="ace ace-switch ace-switch-7" id="active" type="checkbox" value="1" checked />
					<span class="lbl"></span>
				</label>
			</div>
			<div class="help-block col-xs-12 col-sm-reset inline red"></div>
