		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-xs-12 col-sm-3">
					<input type="text" name="code" id="code" class="width-100 r" value="" onkeyup="validCode(this)" placeholder="Allow only  a-z, A-Z, 0-9,  - ,  _" autofocus required />
				</div>
				<div class="help-block col-xs-12 col-sm-reset inline grey e" id="code-error"></div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-12 col-sm-3">
					<select name="category_code" id="category" class="form-control input-sm r" required>
						<option value="">โปรดเลือก</option>
			...
			<div class="form-group">
				...
				<div class="col-xs-12 col-sm-3">
					<select name="kind_code" id="kind" class="form-control input-sm r" required>
						<option value="">โปรดเลือก</option>
			...
			<div class="form-group">
				...
				<div class="col-xs-12 col-sm-3">
					<select name="type_code" id="type" class="form-control input-sm r" required>
						<option value="">โปรดเลือก</option>
			...
			<div class="form-group">
				...
				<div class="col-xs-12 col-sm-3">
					<select name="year" id="year" class="form-control input-sm r" required>
