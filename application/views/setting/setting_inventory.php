	<form id="inventoryForm" method="post" action="<?php echo $this->home; ?>/update_config">
		<div class="row">
			...
			<div class="divider"></div>
			<div class="col-lg-4 col-md-4 col-sm-4">
				<span class="form-control left-label">บันทึกน้ำหนักตอนแพ็คสินค้า</span>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8">
				<label style="padding-top:5px; margin-bottom:0px;">
					<input class="ace ace-switch ace-switch-7" data-name="WEIGHT_ON_PACK" type="checkbox" value="1" <?php echo is_checked($WEIGHT_ON_PACK, '1'); ?> onchange="toggleOption($(this))" />
					<span class="lbl margin-left-0" data-lbl="OFF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ON"></span>
				</label>
				<input type="hidden" name="WEIGHT_ON_PACK" value="<?php echo $WEIGHT_ON_PACK; ?>" />
				<span class="help-block">บันทึกน้ำหนักตอนแพ็คสินค้าหรือไม่</span>
			</div>
			...
			<div class="col-lg-8 col-md-8 col-sm-8">
				<label style="padding-top:5px; margin-bottom:0px;">
					<input class="ace ace-switch ace-switch-7" data-name="VIDEO_ON_PACK" type="checkbox" value="1" <?php echo is_checked($VIDEO_ON_PACK, '1'); ?> onchange="toggleOption($(this))" />
					<span class="lbl margin-left-0" data-lbl="OFF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ON"></span>
				</label>
				<input type="hidden" name="VIDEO_ON_PACK" id="video-on-pack" value="<?php echo $VIDEO_ON_PACK; ?>" />
				<span class="help-block">บันทึก Video การแพ็คสินค้าหรือไม่</span>
			</div>

			<div class="col-lg-4 col-md-4 col-sm-4">
				<span class="form-control left-label">บันทึก Video แบบมีเสียง</span>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8">
				<label style="padding-top:5px; margin-bottom:0px;">
					<input class="ace ace-switch ace-switch-7" data-name="AUDIO_ON_PACK" type="checkbox" value="1" <?php echo is_checked($AUDIO_ON_PACK, '1'); ?> onchange="toggleOption($(this))" />
					<span class="lbl margin-left-0" data-lbl="OFF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ON"></span>
				</label>
				<input type="hidden" name="AUDIO_ON_PACK" id="audio-on-pack" value="<?php echo $AUDIO_ON_PACK; ?>" />
				<span class="help-block">บันทึก Video แบบมีเสียงด้วยหรือไม่</span>
			</div>

			<div class="col-lg-4 col-md-4 col-sm-4">
				<span class="form-control left-label">บันทึก Video อัตโนมัติ</span>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8">
				<label style="padding-top:5px; margin-bottom:0px;">
					<input class="ace ace-switch ace-switch-7" data-name="VIDEO_ON_PACK_AUTO_RECORD" type="checkbox" value="1" <?php echo is_checked($VIDEO_ON_PACK_AUTO_RECORD, '1'); ?> onchange="toggleOption($(this))" />
					<span class="lbl margin-left-0" data-lbl="OFF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ON"></span>
				</label>
				<input type="hidden" name="VIDEO_ON_PACK_AUTO_RECORD" id="auto-record" value="<?php echo $VIDEO_ON_PACK_AUTO_RECORD; ?>" />
				<span class="help-block">บันทึก Video อัตโนมัติทันทีที่เปิดหน้าจอแพ็คสินค้าหรือไม่</span>
			</div>

			<div class="col-lg-4 col-md-4 col-sm-4">
				<span class="form-control left-label">Video source endpoint</span>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8">
				<input type="text" class="form-control input-sm input-xxlarge" name="VIDEO_SOURCE_ENDPOINT" value="<?php echo $VIDEO_SOURCE_ENDPOINT; ?>" />
				<span class="help-block">endpoint สำหรับบันทึก/เปิด ไฟล์วิดีโอ</span>
			</div>

			<div class="col-lg-4 col-md-4 col-sm-4">
				<span class="form-control left-label">Video endpoint secret</span>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8">
				<input type="text" class="form-control input-sm input-xxlarge" name="VIDEO_ENDPOINT_SECRET" value="<?php echo $VIDEO_ENDPOINT_SECRET; ?>" />
				<span class="help-block">secret key สำหรับบันทึก/เปิด ไฟล์วิดีโอ</span>
			</div>

			<div class="col-lg-4 col-md-4 col-sm-4">
				<span class="form-control left-label">Video source owner</span>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8">
				<input type="text" class="form-control input-sm input-medium" name="VIDEO_SOURCE_OWNER" value="<?php echo $VIDEO_SOURCE_OWNER; ?>" />
				<span class="help-block">owner folder สำหรับบันทึก/เปิด ไฟล์วิดีโอ</span>
			</div>
