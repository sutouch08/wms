<div class="row">
    ...
    <div class="col-lg-5-harf col-md-5 col-sm-8-harf col-xs-12 padding-5">
    ...
    <div class="col-lg-2 col-md-2 col-sm-2-harf col-xs-6 padding-5">
      ...
      <input type="text" class="form-control input-sm edit" id="user_ref" name="user_ref" value="<?php echo $order->user_ref; ?>" disabled />
		...
		<div class="col-lg-2-harf col-md-2-harf col-sm-5 col-xs-8 padding-5">
			<label>คลัง</label>
		...
		<?php if(empty($approve_view) && ($this->pm->can_add OR $this->pm->can_edit)): ?>
			<div class="col-lg-7 col-md-6-harf col-sm-10-harf col-xs-9 padding-5">
	...
	<?php else : ?>
		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 padding-5">
			<label>หมายเหตุ</label>
			<input type="text" class="form-control input-sm edit" name="remark" id="remark" value="<?php echo $order->remark; ?>" disabled />
		</div>
	<?php endif; ?>
