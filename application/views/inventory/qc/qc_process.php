...
<?php $this->load->view('inventory/qc/style_qc_process'); ?>
...
<div id="row" style="display:flex;">
    ...
    <div id="video-box" class="hide">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5">
        <div class="btn-group width-100">
          <button class="btn btn-xs btn-purple width-25" onclick="selectCameras()" title="Select Camera"><i class="fa fa-cogs"></i></button>
  ...
  <div id="info-box">
    ...
    <div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-6 padding-5 hidden-sm">
      <label>อ้างอิง</label>
...
<input type="hidden" id="video-on-pack" value="<?php echo $this->video_on_pack ? 1 : 0; ?>" />
<input type="hidden" id="weight-on-pack" value="<?php echo $this->weight_on_pack ? 1 : 0; ?>" />
...
<input type="hidden" id="video-config"
  ...
  data-endpoint="<?php echo getConfig('VIDEO_SOURCE_ENDPOINT'); ?>"
  data-secret="<?php echo getConfig('VIDEO_ENDPOINT_SECRET'); ?>"
  data-owner="<?php echo getConfig('VIDEO_SOURCE_OWNER'); ?>" />
<hr />
