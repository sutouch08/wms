...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5">
  <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4 padding-5">
    ...
    <button type="button" class="btn btn-xs btn-info btn-block" id="btn-add-box" 
    onclick="confirmSaveBeforeAddBox()" <?php echo $disActive; ?>>เพิ่มกล่อง (F1)</button>
  </div>
  ...
  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 padding-5">
    ...
    <input type="text" class="form-control input-sm text-center item focus" id="barcode-item" <?php echo $disActive; ?>/>
  </div>
  ...
  <div class="col-lg-1-harf col-md-2-harf col-sm-2-harf col-xs-3 padding-5">
    ...
    <button type="button" class="btn btn-xs btn-primary btn-block" id="btn-print-address" onclick="printAddress(<?php echo $order->id_address; ?>, '<?php echo $order->code; ?>', <?php echo $order->id_sender; ?>)">ใบปะหน้า</button>
  </div>
