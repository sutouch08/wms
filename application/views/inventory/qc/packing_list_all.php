...
foreach($boxes as $box)
{
  ...
  $header .= '<td class="middle text-center font-size-48 blod" style="width:20%; border-left:solid 1px #CCC; border-bottom:solid 1px #ccc;"><span class="display-block" style="font-size:12px; text-align:center">กล่องที่</span>'.$box->box_no.'/'.$all_box.'</td>';
