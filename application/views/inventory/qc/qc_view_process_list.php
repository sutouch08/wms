		...
		<table class="table table-hover border-1 no-border-xs table-listing">
			<thead>
				<tr>
					...
					<th class="min-width-300 middle hidden-xs">ลูกค้า/พนักงาน</th>
				...
				<?php if(!empty($orders)) : ?>
					...
					<?php foreach($orders as $rs) : ?>
						...
						<tr id="row-<?php echo $rs->code; ?>">
							...
							<td class="middle hidden-xs"><?php echo $rs->code; ?></td>
		...
		<div class="pg-footer-content text-right">
			...
			<div class="footer-menu width-25">
				<button class="btn btn-block" style="border:none; padding:0; background-color:transparent !important;" onclick="goBack()">
					<i class="fa fa-cubes fa-2x white"></i><span class="fon-size-12">รอตรวจ</span>
				</button>
			</div>
			<div class="footer-menu width-25">
