    ...
    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 padding-5">
      ...
      <button type="button" class="btn btn-xs btn-primary btn-block" onclick="add_item()">เพิ่ม</button>
		...
		<div class="col-lg-1 col-md-1-harf col-sm-1-harf col-xs-12 padding-5">
			...
			<button type="button" class="btn btn-xs btn-danger btn-block" onclick="deleteChecked()">ลบที่เลือก</button>
		</div>
    <div class="col-lg-1 col-md-1-harf col-sm-1-harf col-xs-12 padding-5">
      <label class="display-block not-show">clear</label>
      <button type="button" class="btn btn-xs btn-warning btn-block" onclick="clearReturnQty()">เคลียร์ยอด</button>
    </div>
</div>
