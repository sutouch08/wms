<div class="row" style="margin-left: -8px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive" style="min-height:300px; max-height:600px; overflow:scroll; padding:0px; border:solid 1px #dddddd;">
    <table class="table table-bordered tableFixHead" style="min-width:1110px; margin-bottom:20px;">
      <thead>
        <tr class="font-size-11">
          <th class="fix-width-40 middle text-center fix-header">#</th>
          <th class="fix-width-40 text-center fix-header">Batch</th>
          ...
          <th class="fix-width-120 middle fix-header">From Bin</th>
        ...
        <?php if( ! empty($details)) : ?>
          ...
          <?php foreach($details as $rs) : ?>
            ...
            <tr id="row-<?php echo $uid; ?>" data-uid="<?php echo $uid; ?>" class="font-size-11">
              ...
              <td class="middle">
                <input type="text" class="form-control input-xs text-label r" value="<?php echo $rs->unitMsr; ?>"  readonly/>
              </td>
            </tr>
            <?php $no++; ?>
            ...
            <?php if( ! empty($rs->batchRows)) : ?>
              <?php foreach($rs->batchRows as $rb) : ?>
                ...
                <tr id="batch-rows-<?php echo $uuid; ?>" data-uid="<?php echo $uuid; ?>" class="blue font-size-11 child-of-<?php echo $uid; ?>">
                  ...
                  <td class="middle">
                    <input type="text" class="form-control input-xs text-label blue r" value="<?php echo $rb->fromWhsCode; ?>" readonly />
                  </td>
                  <td class="middle">
                    <input type="text" class="form-control input-xs text-label blue r" value="<?php echo $rb->fromBinCode; ?>" readonly />
                  </td>
                  <td class="middle">
                    <input type="text" class="form-control input-xs text-label blue r" value="<?php echo $rb->toWhsCode; ?>" readonly />
                  </td>
                  <td class="middle">
                    <input type="text" class="form-control input-xs text-label blue r" value="<?php echo $rb->toBinCode; ?>" readonly />
                  </td>
                  <td class="middle">
...
<div class="row">
  ...
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-5">
    <?php if($doc->Status == 'D') : ?>
    <p class="logs-text">ยกเลิก โดย : <?php echo $doc->cancel_user; ?> @ <?php echo thai_date($doc->cancel_date, true); ?></p>
    <p class="logs-text">เหตุผล : <?php echo $doc->cancel_reason; ?></p>
  <?php endif; ?>
  </div>
</div>
	...
	{{#each this}}
		...
		{{else}}
			<tr class="font-size-11 pi-rows">
				...
				<td class="middle text-right">{{BalanceQty}}</td>
