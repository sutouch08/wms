<div class="col-lg-9-harf col-md-9 col-sm-9 padding-right-15" style="padding-left:17px;">
  <div class="form-horizontal">
    <div class="form-group hidden-xs">
			<label class="sap-label col-lg-1-harf col-md-2-harf col-sm-2-harf col-xs-4 padding-0">Doc No. (Ecom No.)</label>
      ...
      <label class="sap-label fix-width-60">IX Ref</label>
      <div class="col-lg-2 col-md-3 col-sm-3 col-xs-8 padding-5">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5 col-md-6 col-sm-7-harf col-xs-8 padding-5">
        <select class="form-control input-xs h" id="toWhsCode" onchange="binCodeInit()">
          <?php echo select_warehouse(getConfig('DEFAULT_WAREHOUSE')); ?>
        </select>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-md-5 col-sm-4 col-xs-8 padding-5">
        <input type="text" id="bin-code" class="form-control input-xs h" maxlength="200" value=""/>
      </div>
      <div class="col-lg-5 col-md-4 col-sm-5 col-xs-8 padding-5 hidden-xs">
