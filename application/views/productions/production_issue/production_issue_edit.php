...
<div class="row">
  <!-- Left column -->
  <?php $this->load->view('productions/production_issue/production_issue_edit_header_left'); ?>
  <!-- Right Column -->
  <?php $this->load->view('productions/production_issue/production_issue_edit_header_right'); ?>
</div>
<hr class="padding-5">

<?php $this->load->view('productions/production_issue/production_issue_edit_details'); ?>

<script src="<?php echo base_url(); ?>scripts/productions/production_issue/production_issue.js?v=<?php echo date('Ymd'); ?>"></script>
<script src="<?php echo base_url(); ?>scripts/productions/production_issue/production_issue_add.js?v=<?php echo date('Ymd'); ?>"></script>
