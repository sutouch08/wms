...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive">
    ...
    <?php foreach($data as $rs) : ?>
      <tr class="font-size-11" id="row-<?php echo $rs->id; ?>" style="<?php echo issue_status_color($rs->Status); ?>">
				<td class="middle">
        ...
        <td class="middle text-center no"><?php echo $no; ?></td>
				<td class="middle text-center"><?php echo production_issue_status_text($rs->Status); ?></td>
