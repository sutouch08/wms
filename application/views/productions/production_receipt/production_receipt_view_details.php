      ...
      <?php if( ! empty($details)) : ?>
        ...
        <?php foreach($details as $rs) : ?>
          ...
          <tr id="row-<?php echo $uid; ?>" data-uid="<?php echo $uid; ?>" class="font-size-11">
            ...
            <td class="middle">
              <input type="text" class="form-control input-xs text-label text-right receipt-qty r" data-uid="<?php echo $uid; ?>" id="receipt-qty-<?php echo $uid; ?>" value="<?php echo number($rs->Qty, 2); ?>" readonly/>
            </td>
            <td class="middle">
          ...
          <?php if( ! empty($rs->batchRows)) : ?>
            ...
            <?php foreach($rs->batchRows as $rb) : ?>
              ...
              <tr id="batch-rows-<?php echo $uuid; ?>" data-uid="<?php echo $uuid; ?>" class="blue font-size-11 child-of-<?php echo $uid; ?> hide">
                <td class="middle text-center italic"><?php echo $bno; ?></td>
