...
<div class="modal fade" id="batch-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
	<div class="modal-dialog" style="width:900px; max-width:95vw;">
		<div class="modal-content">
  			<div class="modal-header" id="batch-modal-header" style="border-bottom:solid 1px #e5e5e5;">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">
					<span id="batch-modal-title"></span>
					<span class="pull-right" id="receipt-qty" style="margin-right:25px;">0</span>
	...
	{{#each this}}
		...
		{{else}}
			<tr class="font-size-11 bi-rows" id="bi-row-{{uid}}">
				...
				<td class="middle">
					<input type="number" class="form-control input-xs text-right bi-qty"
					id="bi-qty-{{uid}}"
					data-uid="{{uid}}"
					data-batch="{{BatchNum}}"
