...
<div class="row">
  <!-- Left column -->
  <?php $this->load->view('productions/production_receipt/production_receipt_edit_header_left'); ?>
  <!-- Right Column -->
  <?php $this->load->view('productions/production_receipt/production_receipt_edit_header_right'); ?>
</div>
<hr class="padding-5">

<?php $this->load->view('productions/production_receipt/production_receipt_edit_details'); ?>
