<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-left-15" style="padding-right:12px;">
	<div class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-8 padding-5">
				<input type="text" id="doc-num" class="form-control input-xs h" value="" disabled/>
			</div>
		</div>
    <div class="form-group">
    ...
    <div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-8 padding-5">
				<input type="text" id="date-add" class="form-control input-xs h" value="<?php echo thai_date($doc->date_add, FALSE); ?>" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-8 padding-5">
				<input type="text" id="posting-date" class="form-control input-xs h" value="<?php echo thai_date($doc->shipped_date, FALSE); ?>" />
			</div>
		</div>
	</div>
</div>
