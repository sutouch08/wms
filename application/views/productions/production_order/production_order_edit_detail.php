          ...
          <?php if( ! empty($details)) : ?>
            <?php foreach($details as $rs) : ?>
              ...
              <tr id="row-<?php echo $uid; ?>" data-uid="<?php echo $uid; ?>" class="font-size-11">
                <td class="middle text-center pointer fix-no no" scope="row" onclick="toggleChecked('<?php echo $uid; ?>')"><?php echo $no; ?></td>
                <td class="middle">
                  <input type="text" class="form-control input-xs text-label text-center" value="Item" readonly />
                  <input type="hidden" id="type-<?php echo $uid; ?>" value="4" />
                  <input type="checkbox" class="chk hide" id="row-chk-<?php echo $uid; ?>" data-uid="<?php echo $uid; ?>" />
                </td>
                <td class="middle">
                ...
                <td class="middle">
                  <input type="text" class="form-control input-xs text-label text-right base-qty r" data-uid="<?php echo $uid; ?>" id="base-qty-<?php echo $uid; ?>" value="<?php echo number($rs->BaseQty, 2); ?>" onchange="recalQty('<?php echo $uid; ?>')" />
                </td>
                <td class="middle">
                ...
                <td class="middle">
                  <input type="text" class="form-control input-xs text-label text-right planned-qty r" data-uid="<?php echo $uid; ?>" id="planned-qty-<?php echo $uid; ?>" value="<?php echo number($rs->PlannedQty, 2); ?>"  readonly/>
                </td>
                <td class="middle">
...
<script id="details-template" type="text/x-handlebarsTemplate">
  {{#each this}}
    <tr id="row-{{uid}}" data-uid="{{uid}}" class="font-size-11">
      ...
      <td class="middle">
        <input type="text" class="form-control input-xs text-label text-center" value="Item" readonly />
        <input type="hidden" id="type-{{uid}}" value="4" />
      ...
      <td class="middle">
        <input type="text" class="form-control input-xs text-label text-center" value="Manual" readonly />
        <input type="hidden" id="issue-type-{{uid}}" value="M" />
      </td>
    </tr>
  {{/each}}
</script>
