...
<div class="row">
  ...
  <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-6 padding-5 margin-bottom-10">
	...
	<div class="col-lg-3 col-md-3-harf col-sm-4 col-xs-6 padding-5 margin-bottom-10">
    <input type="text" class="form-control input-sm text-center item-control" id="item-name" placeholder="Description" readonly>
  </div>

	<div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 padding-5 margin-bottom-10">
    <input type="number" class="form-control input-sm text-center item-control" id="item-qty" value="1" />
  </div>
