...
<div class="row">
  ...
  <?php if(($this->pm->can_add OR $this->pm->can_edit) && $doc->status != 'C') : ?>
    <button type="button" class="btn btn-white btn-primary top-btn" onclick="getUploadFile()"><i class="fa fa-upload"></i> &nbsp; Import Items</button>
		<button type="button" class="btn btn-white btn-purple top-btn" onclick="exportData()"><i class="fa fa-file-excel-o"></i> Export</button>
  <?php endif; ?>
