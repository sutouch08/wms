...
{
  private $tb = 'return_consignment';
  private $tb_detail = 'return_consignment_detail';
  ...
  public function update_received_qty($code)
  {
    return $this->db
    ->set('receive_qty', 'qty', FALSE)
    ->set('valid', 1)
    ->where('return_code', $code)
    ->update('return_consignment_detail');
  }
